...
(function () {
  ...
  <iframe src="${root}engine/AkariNet-VRM-v2?modelUrl=./characters/akari/VRM/Akari-optimized.vrm&debug=false" class="avatariframe" allowtransparency="true" style="background:transparent;background-color:transparent;"></iframe>
  `;
